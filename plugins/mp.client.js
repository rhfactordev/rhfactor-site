/**
 *
 * @type {{instance: mp.instance, cardForm: mp.cardForm}}
 */
const mp = {
    ...
    return {
        provide:{
            mp:(key)=>{
                return {
                    createForm : () => {
                        console.log('Criou formulário de cartão.')
                    },
                    destroyForm : () => {
                        console.log('Destruir formulário de cartão.')
                    },
                }
            }
        }
